...
|-----|----------------|---------------|-------------|-------------|----------
|86|[Maximum Matching of Players With Trainers](https://leetcode.com/problems/maximum-matching-of-players-with-trainers/)| [Java](../leetcode/MatchPlayersAndTrainers.java), [Python](../leetcode/matchPlayersAndTrainers.py), [Javascript](../leetcode/matchPlayersAndTrainers.js), [Rust](../leetcode/matchPlayersAndTrainers.rs) | Easy | Sorting | |
