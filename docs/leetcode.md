...
|-----|----------------|---------------|-------------|-------------|----------
|62|[Contains Duplicate](https://leetcode.com/problems/contains-duplicate/) | [Java](../leetcode/ContainsDuplicate.java), [Python](../leetcode/ContainsDuplicate.py)  | Easy | HashMap |  |
